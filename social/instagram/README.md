...
The templates use the same core website system: Yum red `#dc3439`, bright red `#e03a3e`, deep red `#b4212b`, white `#ffffff`, light blue `#cae4fd`, soft blue `#aed2ef`, ink `#2d2d2d`, body gray `#736e6e`, Archivo Narrow, Trocchi, the circular Yum mark, and live site food photography from `yumkitchen-web/public/images`.
