# social copy and alt text

Use platform-native links and calls to action at publish time. The copy below stays short enough to leave the creative in charge.

## people behind yum!

Caption: The people behind your yum! Real kitchens, a real team, and food made from scratch. Meet more of the team at the link in bio.

Alt text by placement:

- Story: Two people smiling at a table inside yum! Kitchen and Bakery above one baby-blue panel reading “meet the people behind yum!” in red.
- Feed and square: A smiling yum! kitchen team member in a working kitchen above a baby-blue panel reading “meet the people behind yum!” in red.
- Wide: A smiling person inside a busy yum! restaurant beside a baby-blue panel with the same message and a Meet the Team action.

## pick your kitchen carousel

Caption: Four kitchens, one very good decision. Swipe through St. Louis Park, Shady Oak, St. Paul, and Woodbury - then pick your yum!
...
Caption: Feeding a meeting, team lunch, or full room? Start with the date and headcount, then build from boxed lunches, trays, and bakery.
...
Caption: Send cake, not a card. Start with the moment, add the message, and let the bright blue Yum box do the announcing.
...
- Catering: Boxed lunches, trays, bakery. Tell us the date and headcount.
- Gifting: Send cake, not a card. Add the message and share the first slice.
- Birthdays: Birthday cake, handled. Share the date, message, and cake details.
- Weddings and events: Cake for the table. Start with the date and the details.
