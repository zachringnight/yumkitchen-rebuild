...
const faqSections = [
  {
    ...
    items: [
      ...
      { q: 'Can I send cakes to more than one person?', a: 'Yes. At checkout you can send the same cake to several addresses at once, which is handy for teams, family, and thank-yous.' },
