...
- Screenshots + manifest: `qa_screenshots_2026-07-09/`
- Route metadata dump: `qa_screenshots_2026-07-09/route-meta.json`
- Lighthouse raw output: /tmp/yum-lh-qa.json (per-page runs)
