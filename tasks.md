...
Implementation branch for this round: `codex/creative-regression-guard`. The stable release branch remains `main`. Current report: `docs/history/plans/2026-07-17-creative-regression-guard/run-report.md`. Stable handoff: `docs/HANDOFF_CURRENT.md`.
